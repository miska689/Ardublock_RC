...
public class BPM_available
extends TranslatorBlock {
    public BPM_available(Long l, Translator translator, String string, String string2, String string3) {
    ...
    public String toCode() throws SocketNullException, SubroutineNotDeclaredException {
        ...
        String string2 = "pulseSensor" + string + ".sawStartOfBeat()";
        return string2;
    }
}

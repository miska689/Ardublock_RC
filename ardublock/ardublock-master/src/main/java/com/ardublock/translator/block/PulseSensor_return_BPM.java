...
public class PulseSensor_return_BPM
extends TranslatorBlock {
    public PulseSensor_return_BPM(Long l, Translator translator, String string, String string2, String string3) {
    ...
    public String toCode() throws SocketNullException, SubroutineNotDeclaredException {
        ...
        String string2 = "pulseSensor" + string + ".getBeatsPerMinute()";

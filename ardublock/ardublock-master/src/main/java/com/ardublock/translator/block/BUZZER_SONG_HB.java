...
public class BUZZER_SONG_HB
extends TranslatorBlock {
    public BUZZER_SONG_HB(Long l, Translator translator, String string, String string2, String string3) {
    ...
    public String toCode() throws SocketNullException, SubroutineNotDeclaredException {
        ...
        return this.codePrefix + "HappyBirthday(" + string + ");" + this.codeSuffix;
    }
}

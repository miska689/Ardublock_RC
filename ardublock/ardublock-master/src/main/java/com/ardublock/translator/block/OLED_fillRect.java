...
public class OLED_fillRect
extends TranslatorBlock {
    public OLED_fillRect(Long l, Translator translator, String string, String string2, String string3) {
    ...
    public String toCode() throws SocketNullException, SubroutineNotDeclaredException {
        ...
        return this.codePrefix + "\noled.fillRect(" + string + ", " + string2 + ", " + string3 + ", " + string4 + ", SSD1306_WHITE); \noled.display(); \n" + this.codeSuffix;
    }
}

...
public class SmartCar_init
extends TranslatorBlock {
    public SmartCar_init(Long l, Translator translator, String string, String string2, String string3) {
        super(l, translator, string, string2, string3);
    }

    public String toCode() throws SocketNullException, SubroutineNotDeclaredException {
        String string = this.getRequiredTranslatorBlockAtSocket(0).toCode();
        this.translator.addHeaderFile("ROBOCODE_SmartCar.h");
        this.translator.addDefinitionCommand("SmartCar mySmartCar(" + string + ");");

...
public class OLED_fillCircle
extends TranslatorBlock {
    public OLED_fillCircle(Long l, Translator translator, String string, String string2, String string3) {
    ...
    public String toCode() throws SocketNullException, SubroutineNotDeclaredException {
        ...
        return this.codePrefix + "\noled.fillCircle(" + string + ", " + string2 + ", " + string3 + ", SSD1306_WHITE); \noled.display(); \n" + this.codeSuffix;
    }
}

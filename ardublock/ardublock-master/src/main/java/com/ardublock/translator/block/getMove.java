...
extends TranslatorBlock {
    public getMove(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label) {
        super(blockId, translator, codePrefix, codeSuffix, label);
    }

    public String toCode() throws SocketNullException, SubroutineNotDeclaredException {
        return String.valueOf(this.codePrefix) + "sword.getMove()" + this.codeSuffix;
    }
}

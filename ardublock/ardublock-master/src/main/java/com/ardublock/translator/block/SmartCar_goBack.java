...
public class SmartCar_goBack
extends TranslatorBlock {
    public SmartCar_goBack(Long l, Translator translator, String string, String string2, String string3) {
        super(l, translator, string, string2, string3);
    }

    public String toCode() throws SocketNullException, SubroutineNotDeclaredException {
        String string = "mySmartCar.goBack();";

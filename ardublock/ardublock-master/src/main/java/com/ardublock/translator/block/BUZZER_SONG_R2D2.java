...
public class BUZZER_SONG_R2D2
extends TranslatorBlock {
    public BUZZER_SONG_R2D2(Long l, Translator translator, String string, String string2, String string3) {
    ...
    public String toCode() throws SocketNullException, SubroutineNotDeclaredException {
        ...
        return this.codePrefix + "SoundR2D2(buzzerPin, ledPin);" + this.codeSuffix;
    }
}

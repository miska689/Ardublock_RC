...
public class OLED_drawCircle
extends TranslatorBlock {
    public OLED_drawCircle(Long l, Translator translator, String string, String string2, String string3) {
    ...
    public String toCode() throws SocketNullException, SubroutineNotDeclaredException {
        ...
        return this.codePrefix + "\noled.drawCircle(" + string + ", " + string2 + ", " + string3 + ", SSD1306_WHITE); \noled.display(); \n" + this.codeSuffix;
    }
}

...
public class LED_matrix_brightness
extends TranslatorBlock {
    public LED_matrix_brightness(Long l, Translator translator, String string, String string2, String string3) {
    ...
    public String toCode() throws SocketNullException, SubroutineNotDeclaredException {
        ...
        String string2 = "matrix.setIntensity(0, " + string + ");";

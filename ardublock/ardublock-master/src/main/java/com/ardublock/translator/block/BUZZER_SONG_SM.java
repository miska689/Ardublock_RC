...
public class BUZZER_SONG_SM
extends TranslatorBlock {
    public BUZZER_SONG_SM(Long l, Translator translator, String string, String string2, String string3) {
    ...
    public String toCode() throws SocketNullException, SubroutineNotDeclaredException {
        ...
        return this.codePrefix + "SuperMario(" + string + ");" + this.codeSuffix;
    }
}

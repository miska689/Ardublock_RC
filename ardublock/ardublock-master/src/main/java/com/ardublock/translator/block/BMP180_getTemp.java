...
public class BMP180_getTemp
extends TranslatorBlock {
    public BMP180_getTemp(Long l, Translator translator, String string, String string2, String string3) {
    ...
    public String toCode() throws SocketNullException, SubroutineNotDeclaredException {
        ...
        String string = "bmp.readTemperature()";

...
public class OLED_drawRect
extends TranslatorBlock {
    public OLED_drawRect(Long l, Translator translator, String string, String string2, String string3) {
    ...
    public String toCode() throws SocketNullException, SubroutineNotDeclaredException {
        ...
        return this.codePrefix + "\noled.drawRect(" + string + ", " + string2 + ", " + string3 + ", " + string4 + ", SSD1306_WHITE); \noled.display(); \n" + this.codeSuffix;
    }
}

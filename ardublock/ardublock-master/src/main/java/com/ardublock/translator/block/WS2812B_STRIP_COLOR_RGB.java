...
public class WS2812B_STRIP_COLOR_RGB
extends TranslatorBlock {
    public WS2812B_STRIP_COLOR_RGB(Long l, Translator translator, String string, String string2, String string3) {
    ...
    public String toCode() throws SocketNullException, SubroutineNotDeclaredException {
        ...
        return this.codePrefix + "FastLED.showColor(CRGB(" + string + "," + string2 + "," + string3 + ")); \ndelay(" + string4 + "); \nFastLED.show();" + this.codeSuffix;
    }
}

...
public class BUZZER_SONG_TS
extends TranslatorBlock {
    public BUZZER_SONG_TS(Long l, Translator translator, String string, String string2, String string3) {
    ...
    public String toCode() throws SocketNullException, SubroutineNotDeclaredException {
        ...
        return this.codePrefix + "TetrisSong(" + string + ");" + this.codeSuffix;
    }
}

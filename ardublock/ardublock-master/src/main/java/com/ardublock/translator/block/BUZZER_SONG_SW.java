...
public class BUZZER_SONG_SW
extends TranslatorBlock {
    public BUZZER_SONG_SW(Long l, Translator translator, String string, String string2, String string3) {
    ...
    public String toCode() throws SocketNullException, SubroutineNotDeclaredException {
        ...
        return this.codePrefix + "StarWars(" + string + ");" + this.codeSuffix;
    }
}

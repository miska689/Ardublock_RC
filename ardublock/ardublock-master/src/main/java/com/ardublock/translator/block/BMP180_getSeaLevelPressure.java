...
public class BMP180_getSeaLevelPressure
extends TranslatorBlock {
    public BMP180_getSeaLevelPressure(Long l, Translator translator, String string, String string2, String string3) {
    ...
    public String toCode() throws SocketNullException, SubroutineNotDeclaredException {
        ...
        String string = "bmp.readSealevelPressure()";

...
public class BMP180_getPressure
extends TranslatorBlock {
    public BMP180_getPressure(Long l, Translator translator, String string, String string2, String string3) {
    ...
    public String toCode() throws SocketNullException, SubroutineNotDeclaredException {
        ...
        String string = "bmp.readPressure()";

...
public class LED_matrix_setLED
extends TranslatorBlock {
    public LED_matrix_setLED(Long l, Translator translator, String string, String string2, String string3) {
    ...
    public String toCode() throws SocketNullException, SubroutineNotDeclaredException {
        ...
        String string4 = "matrix.setLed(0, " + string + ", " + string2 + " ," + string3 + ");";
        return this.codePrefix + string4 + this.codeSuffix;
    }
}

...
public class BUZZER_SONG_MC
extends TranslatorBlock {
    public BUZZER_SONG_MC(Long l, Translator translator, String string, String string2, String string3) {
    ...
    public String toCode() throws SocketNullException, SubroutineNotDeclaredException {
        ...
        return this.codePrefix + "MerryChristmas(" + string + ");" + this.codeSuffix;
    }
}
